...
Free-space optical communication uses much the same technology to transmit information through light, however in the field of optical wireless communications the technology is integrated into regular lighting solutions. The result is %todo: fix this paragraph - its too much waffel
...
Many modulation techniques have been developed for the purposes optical wireless communication. These range from advanced techniques such as multiple-subcarrier modulation (MSM) to basic techniques such as on-off keying (OOK) and pulse-position modulation (PPM).
