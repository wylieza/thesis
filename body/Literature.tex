...
%todo: this paragraph could be reworked
...
Optical wireless communication is susceptible to interference and noise produced by most lighting technologies. Light sources such as incandescent light bulbs and the sun produce white noise in the infrared region, while light sources such as the fluorescent light produce cyclostationary noise due to 
%todo: here
...
%saturation of the receiver and noisy input
...
%todo: here briefly go over the simple manchester encoding technique
...
%todo: chat a bit about designing an anti-aliasing filter
