...
\subsection{Optical Communication Theory} %todo: better name for this 'catergories of techniques' 
...
\subsection{Trans-Impedance Amplifiers} %electronic sensing
%todo: maybe rename this and finnish it
...
The photoconductor is constructed out of an intrinsic semi-conductor material. This un-doped material changes resistance in proportion to incident light of a particular wavelength. Unlike extrinsic semiconductor materials, no current is induced in a photoconductor as the photoelectric effect does not apply. Properties such as the sensitivity to different wavelengths of light depend solely on the semiconducting material of the photoconductor \cite{Kingston2003}.

Photodiode theory of operation %here
