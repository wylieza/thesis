...
Notable tradeoffs for increasing bit-rate are diminishing range, resistance to ambient noise and an increase in system complexity. For the purposes of communicating between a tagger and target in laser tag, there are low bandwidth requirements and long range with minimal system complexity is desired.
