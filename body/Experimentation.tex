...
The carrier waveform module was tested under two conditions. Initially the output was traced for a constant input to evaluate the steady state frequency generation. Following this, the output was traced for an input Manchester transmission.
