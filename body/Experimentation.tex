...
An oscilloscope was used to trace the state of the GPIO pin used to indicate when the decoding function was executing. A second probe was used to trace the incoming Manchester waveform, this allowed the length of the timeout period to be measured as well.
