...
This research project aims to decompose and analyse the fundamental components of these laser tag systems. Decomposition involves reducing the high-level system into individual sub-systems. Analysis involves development of hardware modules for each sub-system and evaluating the performance of these sub-systems.
...
The conclusions of this research project will provide a platform for further research and ultimately the design of a laser tag system capable of outperforming currently available consumer and industrial grade systems.
