...
The system overview is sub-divided into two subsystems, the tagger subsystem and target subsystem. These two subsystems further divide into modules. The designed of each module is presented as well an image of the final implementation.
