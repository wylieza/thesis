...
The following functions relating to the generation of a Manchester bit-stream on the pre-defined output GPIO pin were created

\begin{itemize}
	\item get\_parity\_15
	\subitem Processes a 15-bit long data packet and returns the even parity
	\item wrap\_data\_15
	\subitem Processes a 15-bit long data packet and returns 18-bit bitstream for transmission
	\item generate\_manchester
	\subitem Generate Manchester Encoded output on the pre-define GPIO based on the provided bitstream
\end{itemize} 
