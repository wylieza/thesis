...
Table \ref{tbl:max_distances_system} below records the maximum range of the system under different ambient lighting conditions and records how that range changes as a consequence of using the different detector modules.
